...
print("Making test,val and train dataset")
...
print("Accuracy obtained by Logistic Regression model on training data:",LogisticRegressionScore*100)


LogisticRegressionScore = lr.score(X_val, y_val)
print("Accuracy obtained by Logistic Regression model on validation data::",LogisticRegressionScore*100)


LogisticRegressionScore = lr.score(X_test, y_test)
print("Accuracy obtained by Logistic Regression model on test data::",LogisticRegressionScore*100)
